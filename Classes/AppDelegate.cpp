...
bool AppDelegate::applicationDidFinishLaunching()
{
    ...
    if(!glview)
    {
        ...
        //glview->setFrameSize(768, 1024);		// ipad1,2
        //glview->setFrameSize(512, 384);		// ipad1,2  half
		glview->setFrameSize(384, 512);		// ipad1,2
    ...
    // --------------------- Multi-Resolution ----------------
//    glview->setDesignResolutionSize(1363, 768, ResolutionPolicy::NO_BORDER);
    	glview->setDesignResolutionSize(768, 1363, ResolutionPolicy::NO_BORDER);
