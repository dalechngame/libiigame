...
void Common::showAds()
{
    ...
    if (WJUtils::startWith(deviceType, "iPad"))
        WJUtils::showAds(GOOGLE_ADS_ID , ADSIZE_IAB_LEADERBOARD, ADPOS_X_CENTER, ADPOS_Y_TOP, ADWH_AUTO, ADWH_AUTO, wjalNone);
    else
        WJUtils::showAds(GOOGLE_ADS_ID , ADSIZE_BANNER, ADPOS_X_CENTER, ADPOS_Y_TOP, ADWH_AUTO, ADWH_AUTO, wjalNone);

#endif

#if (CC_TARGET_PLATFORM == CC_PLATFORM_ANDROID)

    WJUtils::showAds(GOOGLE_ADS_ID , ADSIZE_BANNER_AUTO, ADPOS_X_CENTER, ADPOS_Y_TOP, ADWH_AUTO, ADWH_AUTO, wjalNone, Vec2::ZERO);
