...
void CommonTemplate::InitData(void)
{
	...
	/*if (lastLoadLanguage == "Chinese")
	{
		...
		temp->Value = "contact@libii.com|Feedback about Wedding Salon! V";
		mapdata.insert(std::make_pair(temp->Key, temp));

		temp = new CommonTemplate();
		temp->Key = "iOS:EMAIL_SHARE";
		temp->Value = "|Wedding Salon!|<html><body>找到一个很好玩的儿童游戏，赶快下载下来玩玩吧！<br><br>这是下载地址: <a href='%s'>%s</a><br><br><a href='%s'><img src='data:image/png;base64,%%@'/></a></body></html>|";
		mapdata.insert(std::make_pair(temp->Key, temp));
		...
		temp->Value = "amzn://apps/android?p=com.libii.weddingsalon";
		mapdata.insert(std::make_pair(temp->Key, temp));

		temp = new CommonTemplate();
		temp->Key = "Amazon:THIS_APP_STORE_URL_LONG";
		temp->Value = "http://www.amazon.com/gp/mas/dl/android?p=com.libii.weddingsalon&showAll=0";
		mapdata.insert(std::make_pair(temp->Key, temp));
		...
		temp->Value = "contact@libii.com|Feedback about Wedding Salon!(Kindle Fire Edition) V";
		mapdata.insert(std::make_pair(temp->Key, temp));

		temp = new CommonTemplate();
		temp->Key = "Amazon:EMAIL_SHARE";
		temp->Value = "|Wedding Salon!|找到一个很好玩的儿童游戏，赶快下载下来玩玩吧！\n\n这是下载地址： %s|";
		mapdata.insert(std::make_pair(temp->Key, temp));
		...
		temp->Value = "market://details?id=com.libii.weddingsalon";
		mapdata.insert(std::make_pair(temp->Key, temp));

		temp = new CommonTemplate();
		temp->Key = "Google:THIS_APP_STORE_URL_LONG";
		temp->Value = "https://play.google.com/store/apps/details?id=com.libii.weddingsalon";
		mapdata.insert(std::make_pair(temp->Key, temp));
		...
		temp->Value = "contact@libii.com|Feedback about Wedding Salon!(Android) V";
		mapdata.insert(std::make_pair(temp->Key, temp));
	...
	else */
	{
		...
		temp = new CommonTemplate();
		temp->Key = "iOS:EMAIL_SHARE";
		temp->Value = "|Wedding Salon!|<html><body>Look the best App for you! <br><br> It's the most fun Kids game.<br><br>Here is a link to Wedding Salon in the App Store: <a href='%s'>%s</a><br><br><a href='%s'><img src='data:image/png;base64,%%@'/></a></body></html>|";
		mapdata.insert(std::make_pair(temp->Key, temp));
		...
		temp = new CommonTemplate();
		temp->Key = "Amazon:EMAIL_SHARE";
		temp->Value = "|Wedding Salon!|Look at the best app for you!\n\nIt's the most fun Kids game.\n\nHere is a link to Wedding Salon in the App Store: %s|";
		mapdata.insert(std::make_pair(temp->Key, temp));
